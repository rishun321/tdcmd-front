...
export default {
  ...
  data: () => ({
    pieces: [
      {_id: '1', name: '亀戸富士マンション', preview: 'city', text: 'ＪＲ総武線 / 亀戸駅 徒歩10分、4階、南向き、２５００万、専有面積、25.51m²'},
      {_id: '2', name: 'リリナー', preview: 'cubes', text: '投資用マーション、中古'},
      {_id: '3', name: '田中竜', preview: 'sechelt', text: '3階建一軒家、新築'},
      {_id: '4', name: '中田龍', preview: 'city', text: '5000万以内であれば、なんでもいい'},
      {_id: '5', name: 'ナースカリスマ', preview: 'cubes', text: '居間は畳、北向き'},
      {_id: '6', name: 'おたくの神', preview: 'sechelt', text: '東陽町付近、マンション'},
      ...
      {_id: '10', name: '五十嵐東海林太郎', preview: 'city', text: '富士山麓、交通便利、贅沢を尽くす別荘'}
    ]
  })
}
</script>
